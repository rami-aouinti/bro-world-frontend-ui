...
const iconClientBundleConfig = false as const;
...
export default defineNuxtConfig({
  ...
  i18n: {
    ...
    locales: [
      { code: "en", name: "English", iso: "en-US", icon: "fi-gb gb" },
      { code: "de", name: "Deutsch", iso: "de-DE", icon: "fi-de de" },
      { code: "fr", name: "Frensh", iso: "fr-FR", icon: "fi-fr fr" },
      { code: "ar", name: "Arabic", iso: "tn-TN", icon: "fi-tn tn" },
      { code: "it", name: "Italian", iso: "it-IT", icon: "fi-it it" },
      { code: "es", name: "Spanish", iso: "es-ES", icon: "fi-es es" },
      { code: "ru", name: "Russian", iso: "ru-RU", icon: "fi-ru ru" },
    ],
  ...
  icon: {
    clientBundle: iconClientBundleConfig,
  ...
  runtimeConfig: {
    ...
    public: {
      ...
      apiGameBase: process.env.NUXT_PUBLIC_GAME_API_BASE ?? "https://game.bro-world.org",
