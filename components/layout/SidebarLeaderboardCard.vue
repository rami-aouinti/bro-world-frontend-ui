  ...
  <SidebarCard class="text-slate-200 px-3 py-2">
    ...
    <ul class="space-y-4">
      <li
          ...
          class="-mx-[var(--card-x)] flex items-center gap-3 px-1 py-2 my-2 mx-1 rounded-2xl border border-white/5 bg-black/20 px-[var(--card-x)] py-3 text-sm text-slate-300"
      >
        <span
