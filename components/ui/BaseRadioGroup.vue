<template>
  <div
    ...
    :class="[
      ...
      directionClass,
      { 'ui-radio-group--disabled': disabledState },
    ]"
    role="radiogroup"
  ...
  >
    ...
    >
      ...
      <button
        ...
        :class="{
          'ui-radio-group__option--checked': isChecked(option),
          'ui-radio-group__option--disabled': option.disabled,
        }"
        role="radio"
      ...
      >
        ...
        <span class="ui-radio-group__texts">
          ...
          <span
            v-if="option.hint"
            class="ui-radio-group__option-hint"
            >{{ option.hint }}</span
          >
        </span>
      </button>
    ...
    <ul
      v-if="showLocalErrors"
      :id="errorId"
      class="ui-radio-group__errors"
      role="list"
    >
      <li
        v-for="message in normalizedErrors"
        :key="message"
        class="ui-radio-group__error-item"
      >
...
const describedBy = computed(() => {
  const ids = [field?.ariaDescribedby.value, hintId.value, errorId.value].filter(
    Boolean,
  ) as string[];
...
const firstEnabledIndex = computed(() =>
  props.options.findIndex((option) => !option.disabled && !disabledState.value),
);
