...
describe('ContactForm', () => {
  ...
  it('submits the form successfully', async () => {
    ...
    await wrapper.find('[data-test="message-field"] textarea').setValue('Looking forward to collaborating on the next release cycle.')
    ...
    expect(
      (wrapper.find('[data-test="name-field"] input').element as HTMLInputElement).value,
    ).toBe('')
    expect(
