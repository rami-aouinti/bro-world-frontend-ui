      ...
      <template #default>
        ...
        <template v-else-if="!isAuthReady">
          <div
            ...
            aria-hidden="true"
          >
            <div class="rounded-3xl border border-slate-200 bg-card p-4 shadow-sm">
              <div class="flex items-start gap-3">
                <div class="h-12 w-12 flex-shrink-0 rounded-full bg-slate-200" />
                <div class="flex-1 space-y-3">
                  <div class="h-3 w-1/3 rounded-full bg-slate-200" />
                  <div class="h-24 rounded-2xl bg-slate-100" />
                  <div class="flex items-center gap-4">
                    <div class="h-9 w-24 rounded-full bg-slate-200" />
                    <div class="h-9 w-24 rounded-full bg-slate-200" />
                  </div>
                </div>
              </div>
            ...
            <div class="rounded-3xl border border-slate-200 bg-card p-4 shadow-sm">
              <div class="h-[240px] rounded-2xl bg-slate-100" />
            </div>
          </div>
        </template>
      </template>
