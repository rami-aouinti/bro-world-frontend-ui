<template>
  <main class="py-12" aria-labelledby="contact-heading">
    <v-container>
      <v-row class="align-stretch" dense>
        <v-col cols="12" md="6">
          <article class="mb-8" aria-describedby="contact-intro">
            <h1 id="contact-heading" class="text-h3 font-weight-bold mb-3">
              {{ t('pages.contact.title') }}
            </h1>
            <p id="contact-intro" class="text-body-1 text-medium-emphasis mb-6">
        ...
        <v-col cols="12" md="6">
          <aside aria-labelledby="contact-support">
            <section class="mb-8">
              <h2 id="contact-support" class="text-h5 font-weight-semibold mb-2">
              ...
              <div class="d-flex flex-column gap-4 mt-5">
                ...
                >
                  <div class="d-flex align-center mb-2">
                    <v-icon :icon="channel.icon" size="28" class="mr-3" aria-hidden="true" />
            ...
            <section class="pa-6 rounded-lg" :class="availabilityClass" aria-labelledby="availability-title">
              <h2 id="availability-title" class="text-h6 font-weight-semibold mb-2">
