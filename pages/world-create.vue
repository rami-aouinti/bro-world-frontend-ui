<template>
  <main aria-labelledby="create-world-heading">
    <section aria-labelledby="create-world-form-title">
      <SidebarCard
    ...
    <section aria-labelledby="create-world-plugins-title">
      <SidebarCard
        class="text-card-foreground px-3 py-3"
        glow
      >
    ...
    <section aria-labelledby="create-world-workflow-title">
      <SidebarCard
        class="text-card-foreground px-3 py-3"
        glow
      >
