<template>
  <main
    class="py-10"
    aria-labelledby="admin-job-management-title"
  >
    <v-container>
      <header class="mb-8">
        <h1
          id="admin-job-management-title"
          class="text-h4 text-lg-h3 font-weight-bold mb-2"
        >
          {{ title }}
        </h1>
        <p
          id="admin-job-management-title-subtitle"
...
const { t, title, subtitle } = useAdminModulePage("admin.jobManagement");
